...
class MovieScreen extends StatelessWidget {
  ...
  final String actors;
  const MovieScreen({super.key, required this.title, required this.plot, required this.poster, required this.year, required this.runtime, required this.imdb, required this.lang, required this.genre, required this.director, required this.actors});
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: screenWidth/40, vertical: screenHeight/40),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Container(
